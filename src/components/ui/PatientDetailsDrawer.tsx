      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white dark:bg-slate-900 shadow-2xl z-50 overflow-y-auto transition-transform duration-300 ease-in-out">
        ...
        <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-start">
          <div>
            ...
            <span
              className={`mt-2 inline-block px-2 py-1 rounded text-xs font-bold uppercase tracking-wider ${priorityColors[patient.priority]}`}
            >
              {patient.priority}
            </span>
          </div>
        ...
        <div className="p-6 space-y-8">
          <section>
            <h3 className="text-sm font-semibold text-slate-400 uppercase mb-4 tracking-widest">
              Current Vitals
            </h3>
          ...
          <section>
            ...
            <div className="p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/30 rounded-xl">
              <textarea
                ...
                className="text-sm w-full resize-none text-slate-700 dark:text-slate-300 leading-relaxed"
              ></textarea>
            </div>
          </section>
        </div>
        ...
        <div className="absolute flex gap-2 bottom-0 left-0 right-0 p-6 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800">
          <button
            onClick={onClose}
            className="w-full bg-gray-500/20 font-bold py-3 rounded-xl transition-colors"
          >
            Cancel
          </button>
